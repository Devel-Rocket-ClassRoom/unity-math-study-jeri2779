...
public class RaycastDemo : MonoBehaviour
{
    ...
    private void TryPlaceObject(RaycastHit hit)
    {
        ...
        GameObject newObj = Instantiate(selectedObject, placePos, selectedObject.transform.rotation);
        newObj.tag = "Untagged";
        newObj.GetComponent<Renderer>().material.color = Color.cyan;
        newObj.name = $"Placed_Object";

        Debug.Log($"[RaycastDemo] 배치됨: {placePos}");
    }
